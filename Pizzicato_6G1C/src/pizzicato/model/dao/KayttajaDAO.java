...
public class KayttajaDAO extends DataAccessObject {
	...
	public ArrayList<Kayttaja> findAll() {
		...
		try {
			conn = getConnection();
			String sqlSelect = "SELECT kayttaja.id, kayttaja.etunimi, kayttaja.sukunimi, kayttaja.salasana, kayttaja.tyyppi, kayttaja.puh, kayttaja.osoite, kayttaja.postinro, kayttaja.email, posti.postinro, posti.postitmp FROM kayttaja JOIN posti ON kayttaja.postinro = posti.postinro;";
	...
	public Kayttaja etsiTunnuksella(String kayttajatunnus) {
		...
		try {
			connection = getConnection();
			String sql = "SELECT kayttaja.id, kayttaja.etunimi, kayttaja.sukunimi, kayttaja.salasana, kayttaja.tyyppi, kayttaja.puh, kayttaja.osoite, kayttaja.postinro, kayttaja.email, posti.postinro, posti.postitmp FROM kayttaja JOIN posti ON kayttaja.postinro = posti.postinro WHERE email = (?);";
