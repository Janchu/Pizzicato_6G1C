...
/**
 * Servlet implementation class AEngListaaPizzatServlet
 */
@WebServlet("/AEngListaaPizzatServlet")
public class AEngListaaPizzatServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Lähetetään jsp:lle
		String jsp = "/view/aeng-listaa-pizzat.jsp";
