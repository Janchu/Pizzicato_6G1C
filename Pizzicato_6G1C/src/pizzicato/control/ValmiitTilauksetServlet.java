...
/**
 * Servlet implementation class ValmiitTilauksetServlet
 */
@WebServlet("/ValmiitTilauksetServlet")
public class ValmiitTilauksetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		// Lähetetään jsp:lle
		String jsp = "/view/valmiit-tilaukset.jsp";
